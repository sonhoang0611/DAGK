...
/*    //Method to register a new student
    ...
    /* public function getAllDesFlights($departflight){
        $stmt = $this->con->prepare("SELECT ap.airplanename FROM flight as fl, airplane as ap WHERE fl.departure = $departflight and fl.destination = ap.airplanecode");
        $stmt->execute();
        $desflights = $stmt->get_result();
        $stmt->close();
        return $desFlights;
    }*/
